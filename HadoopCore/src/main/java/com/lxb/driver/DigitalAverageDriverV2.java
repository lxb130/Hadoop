...
import com.lxb.utils.NumberOperatorUtil;

public class DigitalAverageDriverV2 {
	...
	public static class IntSumReducerV2 extends
		...
		public void reduce(Text key, Iterable<IntWritable> values,
			...
			String format=NumberOperatorUtil.format2Dot(average);
			result.set(format);
			// 将计算结果逐条输出
	...
	public static void main(String[] args) throws Exception {
		...
		// 指定本次执行的主类是WordCount
		job.setJarByClass(DigitalAverageDriverV2.class);
		// 指定map类
